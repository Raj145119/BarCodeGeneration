...
public class BarcodeGenPdf {
	public static void main(String[] args) {
		BarcodeGenPdf.createPDF("documentPdf.pdf","899887667");
	}
	public static void createPDF(String pdfFilename,String myString) {
	    Document doc = new Document();
	    PdfWriter docWriter = null;
	    try {
	        docWriter = PdfWriter.getInstance(doc, new FileOutputStream("D:\\\\barcode\\"+pdfFilename));
